...
Package/sound-soc-intel-sst-firmware = $(call Package/firmware-default,Intel Snd SoC firmware)
define Package/sound-soc-intel-sst-firmware/install
	$(INSTALL_DIR) $(1)/lib/firmware/intel
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/intel/fw_sst_0f28.bin $(1)/lib/firmware/intel
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/intel/fw_sst_0f28.bin-48kHz_i2s_master $(1)/lib/firmware/intel
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/intel/fw_sst_22a8.bin $(1)/lib/firmware/intel
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/intel/IntcSST2.bin $(1)/lib/firmware/intel
	$(INSTALL_DATA) $(PKG_BUILD_DIR)/intel/dsp_fw_release.bin $(1)/lib/firmware/intel
endef
$(eval $(call BuildPackage,sound-soc-intel-sst-firmware))
